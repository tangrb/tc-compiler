...
DISPATCH_POINTS = [
    ...
    },
    {
        ...
        "skip": {
            ...
            "TC_RHS_PTR_ADD": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_SUB": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_EQ": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_NE": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_LT": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_LE": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_GT": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_GE": "Phase 3 type check; const eval deferred",
            "TC_RHS_PTR_SIZE": "Phase 3 type check; const eval deferred",
            "TC_RHS_SELF_MEMBER": "Phase 3 type check; const eval deferred",
        },
    },
    {
        ...
        "line_func": 0,
        "skip": {
            "TC_RHS_MEMBLOCK_LOAD": "Phase 5 runtime",
            "TC_RHS_MEMBLOCK_CONSTRUCTOR": "Phase 5 runtime",
            "TC_RHS_MEMBLOCK_COUNT": "Phase 5 runtime",
            "TC_RHS_STRUCT_CONSTRUCTOR": "Phase 5 runtime",
            "TC_RHS_FIELD_READ": "Phase 5 runtime",
            "TC_RHS_PTR_LOAD": "Phase 5 runtime",
            "TC_RHS_PTR_ADDRESS": "Phase 5 runtime",
            "TC_RHS_PTR_ADD": "Phase 5 runtime",
            "TC_RHS_PTR_SUB": "Phase 5 runtime",
            "TC_RHS_PTR_EQ": "Phase 5 runtime",
            "TC_RHS_PTR_NE": "Phase 5 runtime",
            "TC_RHS_PTR_LT": "Phase 5 runtime",
            "TC_RHS_PTR_LE": "Phase 5 runtime",
            "TC_RHS_PTR_GT": "Phase 5 runtime",
            "TC_RHS_PTR_GE": "Phase 5 runtime",
            "TC_RHS_PTR_SIZE": "Phase 5 runtime",
            "TC_RHS_SELF_MEMBER": "Phase 5 runtime",
        },
        "extra_kinds": ["TC_RHS_CONST_REF, TC_RHS_CONST_CAST"],
    },
    {
