...
**何时读**：快速查 EBNF 结构。完整语法：`docs/TC语言标准设计说明书-0.0.42.md`。
...
权威来源：`docs/TC语言标准设计说明书-0.0.42.md` · 诊断：[errors.md](errors.md) · 模块/函数：[kg-module.md](kg-module.md) / [kg-func.md](kg-func.md)
