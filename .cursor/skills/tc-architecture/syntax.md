# TC 语言语法摘要（语言规范 0.0.44）

**何时读**：快速查 EBNF 结构。完整语法：`docs/TC语言标准设计说明书-0.0.44.md`。
...
权威来源：`docs/TC语言标准设计说明书-0.0.44.md` · 诊断：[errors.md](errors.md) · 模块/函数：[kg-module.md](kg-module.md) / [kg-func.md](kg-func.md)
