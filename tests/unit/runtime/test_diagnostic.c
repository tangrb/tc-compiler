...
static void test_domain_lifecycle(void) {
    ...
    check(print_contains(&diag, ": implementation error: internal error: unresolved field operand"),
          "internal error print omits the language code");
    check(!print_contains(&diag, "SyntaxError"),
          "internal error print does not claim a language error code");
