...
run_expect_fail "$ROOT/tests/errors/static/goto_outside_function.tc" "goto is only allowed inside a function"
run_expect_fail "$ROOT/tests/errors/static/label_outside_function.tc" "label is only allowed inside a function"
run_expect_fail "$ROOT/tests/errors/static/goto_inside_loop.tc" "goto is not allowed inside while"
