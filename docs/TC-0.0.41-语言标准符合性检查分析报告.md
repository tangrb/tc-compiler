...
>
> **收口注记（2026-08-30）**：§1–§13 为 2026-08-27 审计原文，发现项与「完全遵循不成立」均相对当时实现，**不改写**。配套[修复计划](./TC-0.0.41-语言标准符合性修复计划.md) P0–P6 已落地。现行对外结论见文末 **§14**，勿把 §1 当作现状。
...
降级项的实现侧说明见 [TC-AOT 详细设计说明书](./TC-AOT详细设计说明书-0.0.41.md) §19。任务对照与阶段状态见[修复计划](./TC-0.0.41-语言标准符合性修复计划.md) §10。
