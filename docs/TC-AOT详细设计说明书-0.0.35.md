...
>
> **当前实现基线**：TC-AOT v0.0.35（`TC_AOT_VERSION`）
>
> **状态**：0.0.35 代码生成架构设计，涵盖模块系统、函数、memblock、ptr、struct 与完整 C99 代码生成。
>
> **上游契约**：[TC-VM 详细设计说明书](./TC-VM详细设计说明书-0.0.35.md) 的 typed program、完整 CFG 与共享运行时语义
...
| 维度 | 版本 | 状态 |
| ---- | ---- | ---- |
| 目标语言 | TC 0.0.35 | 规范已确定 |
| 编译器规范 | TC 编译器 0.0.35 | 13 阶段管线已确定 |
