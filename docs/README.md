...
>
> **冻结（2026-09-26）**：两份 0.0.45 设计文档已由草案转为冻结文本（状态行、效力范围、变更策略与编译器标准的成对升版条款），锚点为标签 `spec-0.0.45`。冻结后仅接受勘误，任何语义变更必须升版；勘误与跨版本差异统一记录于 `CHANGELOG.md`，设计文档正文不承载修订历史。
...
当前核心版本：**v0.0.44**（语言规范与现行设计文档为 **0.0.44**）。0.0.45 冻结文本见上表，尚未并入实现。
