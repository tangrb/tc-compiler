...
| 文档 | 用途 |
| ---- | ---- |
| [TC-语言标准一致性勘误清单.md](TC-语言标准一致性勘误清单.md) | 0.0.42→0.0.44 一致性勘误与实现同步台账（首轮 63 项 ＋ 第二轮 27 项，均含处置溯源；§9 为实现待办） |
| [TC-0.0.44-修订记录与兼容性说明.md](TC-0.0.44-修订记录与兼容性说明.md) | 0.0.44 跨版本差异与变更记录（D1～D34） |
