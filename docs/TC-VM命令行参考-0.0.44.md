...
> **当前版本**：TC-VM v0.0.44（`TC_VM_VERSION` ⇐ `TC_VERSION_CORE`）
>
> **目标语言规范（唯一权威）**：[TC 0.0.44](./TC语言标准设计说明书-0.0.44.md)
>
> **文档职责**：本页准确描述 0.0.44 可执行文件行为（实现版本 v0.0.44）与兼容边界。
>
...
以下示例适用于 v0.0.44。每个源文件须以 `#program` 或 `#lib` 开头（[语言标准 §4](./TC语言标准设计说明书-0.0.44.md)）；未写模式指令为语法错误。
...
*当前命令行为以 v0.0.44 源码与本页为准，语言规则以 [TC 0.0.44 标准](./TC语言标准设计说明书-0.0.44.md) 为准。*
