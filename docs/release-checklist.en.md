...
- [ ] [CHANGELOG.md](../CHANGELOG.md) / [CHANGELOG.en.md](../CHANGELOG.en.md): move `[Unreleased]` notes into a new `## [X.Y.Z] - YYYY-MM-DD` section and refresh compare links
...
- [ ] Open `[Unreleased]` section again in `CHANGELOG.md` / `CHANGELOG.en.md` for ongoing work
- [ ] Update `SECURITY.md` / `SECURITY.en.md` supported-versions table if the previous release drops out of support
...
- Security fixes: follow [SECURITY.en.md](../SECURITY.en.md) disclosure timing before detailing exploits in the changelog.
