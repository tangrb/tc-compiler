...
>
> **调用者速查**：[libtc API](./libtc-api-0.0.41.md)
...
*语言合法性与错误种类以 [TC 语言标准 0.0.41](./TC语言标准设计说明书-0.0.41.md) 与 [TC 编译器标准 0.0.41](./TC编译器标准设计说明书-0.0.41.md) 为准；当前可调用行为以 [libtc API](./libtc-api-0.0.41.md) 为准。*
